...
define('LOG_SCRIPT_NAME', 'CONVERT_PHASE.INC.PHP');
...
$call_hd =
    ...
    . '-ar '.AUDIO_SAMPLINGRATE_HD.' -af "pan=stereo|c0=c0|c1=-1*c1" '      # Audio sampling rate (Hz) fra config
    . '-s '. $video_resolution_hd.' '       # Videooppløsning
...
$call_mobile =
    ...
    . '-ar '.AUDIO_SAMPLINGRATE_MOBILE.'  -af "pan=stereo|c0=c0|c1=-1*c1" '  # Audio sampling rate (Hz) fra config
    . '-s '. $video_resolution_mobile.' '   # Videooppløsning
...
$call_archive =
    ...
    . '-ar '.AUDIO_SAMPLINGRATE_ARCHIVE.' -af "pan=stereo|c0=c0|c1=-1*c1" '  # Audio sampling rate (Hz) fra config
    . '-s '. $video_resolution_archive.' '   # Videooppløsning
